...
"""
TEN SKRYPT ZOSTAŁ UŻYTY DO WYBORU HIPERPARAMETRÓW modelu z dwiema WARSTWAMI LSTM
"""

#wyłączenie spamowania warningami
...
class UnscaledMetricsCallback(Callback):
    """żeby wyniki były w normalnej skli"""
...
class LSTMOptymalizator2l:

    def __init__(self,
                 csv_path,
                 target_name='pył zawieszony PM10',# domyślny cel predykcji
                 horizons=[1, 3, 6, 12],
                 train_split=0.7,
                 val_split=0.15,
                 # domyślny folder z wynikami, wykresami itp.
                 output_dir='results_lstm_fixed'):
    ...
    def load_data(self):
        ...
        print("na zbiorze test tylko końcowa ocena")
    ...
    def build_model(self, trial, window_size, n_features):
        #budowa modelu lstm, i zakresy hiperparametrów
    ...
    def run_optimization(self, n_trials=20):
        ...
        print(f"Liczba trials: {len(study.trials)}")
    ...
    def _plot_optimization(self, study):
        ...
        # najbardziej wpływowe hiperparametry
        try:
            ...
            print("wykres ważnośći hiperparametrów nie pwostał")

    def train_final_model(self, epochs=100):
        #trening modelu dla najlepszych hiperparametrów
        ...
        # po to żeby 2 razy nie budować tego samego modelu
        class FakowyTrial:
        ...
        print("Architektura modelu (2 warstwy LSTM):")
        model.summary()
        ...
        # do śledzenia treningu ale w normalnej skali
        ...
        print(f"\nRozpoczynam trening (max epochs={epochs})...")
    ...
    def evaluate(self, model, X_test, y_test):
        ...
        print(f"Metryki zostały zapisane: test_metrics.json")
...
def main():
    ...
    model, X_test, y_test = optimizer.train_final_model(epochs=20)
